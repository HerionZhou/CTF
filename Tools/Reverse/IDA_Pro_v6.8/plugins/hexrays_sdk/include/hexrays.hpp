...
#define MERR_MAX_ERR   27
#define MERR_LOOP      (-28)   ///< internal code: redo last loop (never reported)
//@}
...
#define EXFL_ALL     0x001F ///< all currently defined bits
//@}
...
const int HEXRAYS_API_MAGIC2 = 0xBE3CBABE; // xxNNxxxx
